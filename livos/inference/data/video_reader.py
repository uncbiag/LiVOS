...
class VideoReader(Dataset):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize the video reader with video name and folders.

        Args:
        image_dir: Points to a directory of jpg images.
        mask_dir: Points to a directory of png masks.
        size_dir: Points to a directory of jpg images that determines the output size.
        size: Resize min. side to size. Does nothing if size < 0.
        to_save: Optionally contains a list of file names without extensions 
            where the segmentation mask is required
        use_all_mask: When true, read all available mask in mask_dir. Default false. 
            Set to true for YouTubeVOS validation.
        object_name: If none, read from all objects. Otherwise, read that object only.
    ...
    def __getitem__(self, idx):
        ...
        resize_needed = (input_shape != output_shape) or (self.size > 0)
